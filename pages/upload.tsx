    ...
    <div className='flex w-full h-full absolute left-0 top-[60px] lg:top-[70px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center'>
      <div className=' bg-white rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-center items-center p-14 pt-6'>
        <div>
                ...
                {!videoAsset ? (
                  <label className='cursor-pointer'>
                    <div className='flex flex-col items-center justify-center h-full'>
                      ...
                      <p className='bg-[#FFD700] text-center mt-8 rounded text-white text-md font-medium p-2 w-52 outline-none'>
                        Select file
                      </p>
                    </div>
                    <input
          ...
          {wrongFileType && (
            <p className='text-center text-xl text-yellow-400 font-semibold mt-4 w-[260px]'>
        ...
        <div className='flex flex-col gap-3 pb-10'>
          ...
          <div className='flex gap-6 mt-10'>
            ...
            <button
              ...
              onClick={handlePost}
              type='button'
              className='bg-[#FFD700] text-white text-md font-medium p-2 rounded w-28 lg:w-44 outline-none'
            >
